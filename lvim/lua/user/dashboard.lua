...
local buttons = {
    ...
    val = {
        ...
        button("e", " " .. kind.todo_comments.TODO .. " New file", ":ene <BAR> startinsert <CR>"),
        button("r", " " .. kind.icons.docs .. " Recents", ":Telescope oldfiles<CR>"),
        button("s", " " .. kind.icons.magic .. " Restore", ":lua require('persistence').load()<cr>"),
        button("p", " " .. kind.icons.repo .. " Projects", "<CMD>Telescope projects<CR>"),
